...
synth_design -top cronometro_top -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef cronometro_top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file cronometro_top_utilization_synth.rpt -pb cronometro_top_utilization_synth.pb"
