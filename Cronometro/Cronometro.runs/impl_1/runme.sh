...
HD_PWD='C:/Users/augus.DESKTOP-NFORTEC/Documents/FPGA_Proyecto1/Cronometro/Cronometro.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometro_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cronometro_top.tcl -notrace
