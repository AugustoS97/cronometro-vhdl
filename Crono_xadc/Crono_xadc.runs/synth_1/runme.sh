...
HD_PWD='C:/Users/augus.DESKTOP-NFORTEC/Documents/FPGA_Proyecto1/Crono_xadc/Crono_xadc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_crono.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_crono.tcl
