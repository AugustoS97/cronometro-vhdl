...
synth_design -top top_crono -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef top_crono.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file top_crono_utilization_synth.rpt -pb top_crono_utilization_synth.pb"
