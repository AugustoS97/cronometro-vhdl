...
HD_PWD='C:/Users/augus.DESKTOP-NFORTEC/Documents/FPGA_Proyecto1/Crono_xadc/Crono_xadc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_crono.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_crono.tcl -notrace
